...
describe("Drafting Component", () => {
    ...
    const testCases = [
        {
            response: "INVALID",
            expectedText: "Ce que vous avez fourni n'est pas une leçon, vous ne pouvez donc pas créer un examen"
        },
        {
    ...
    it("redirects user upon successful exam creation with a PDF", async () => {
        ...
        const fakeFile = new File(['(⌐□_□)'], 'example.pdf', { type: 'application/pdf' });
